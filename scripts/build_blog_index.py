...
SECTIONS = [
    ...
    ("dossier", "3. Constituer le dossier",
     ...
     ["documents-naturalisation", "casier-judiciaire-naturalisation",
      ...
      "timbre-fiscal-naturalisation", "hausse-timbre-fiscal-naturalisation-mai-2026"]),
    ("entretien", "4. L'entretien en pr&eacute;fecture",
     ...
     ["entretien-naturalisation-prefectures", "questions-entretien-naturalisation",
      "pourquoi-voulez-vous-devenir-francais", "sentrainer-entretien-naturalisation",
    ...
    ("suivi", "5. Suivre son dossier",
     ...
     ["naturalisation-rapide", "suivre-dossier-naturalisation-anef", "statuts-anef-naturalisation",
      "avis-favorable-naturalisation", "delais-naturalisation-2026", "delais-naturalisation-par-prefecture",
    ...
    ("apres", "6. Apr&egrave;s l'obtention",
     ...
     ["journal-officiel-naturalisation-liste-des-noms", "ceremonie-naturalisation-que-se-passe-t-il",
